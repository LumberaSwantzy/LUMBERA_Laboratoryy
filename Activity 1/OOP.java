...
class BankAccount {
    ...
    //Encapsulating: Getter and Setter Methods
...
class CurrentAccount extends BankAccount {
    ...
    public void withdraw(double amount){
        ...
        System.out.println("Withdrawn Amount: " + amount);
                ...
                System.out.println("Invald withdrawal amount or overdraft limit exceeded.");
            }   
    ...
    public class OOP {
        public static void main(String[] args) {
            ...
            SavingsAccount savings = new SavingsAccount ("Ziehl", 5000, 3);
            ...
            CurrentAccount current = new CurrentAccount("Khxile", 3000, 2000);
